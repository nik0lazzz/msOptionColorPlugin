...
class msOptionColorPluginOfficeItemUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('msoptioncolorplugin_item_err_ns');
        }
...
return 'msOptionColorPluginOfficeItemUpdateProcessor';
